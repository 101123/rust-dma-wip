...
// Normalizes a vector, asserts if the vector can't be normalized
...
inline float Angle(const Vector3f& lhs, const Vector3f& rhs) { return ::acos(fminf(1.0f, fmaxf(-1.0f, Dot(lhs, rhs) / (Magnitude(lhs) * Magnitude(rhs))))); }
